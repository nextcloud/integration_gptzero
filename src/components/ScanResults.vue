	...
	<div class="scan-results">
		...
		<div class="overall-results">
			<p>
				...
				<NcProgressBar :value="document.average_generated_prob" :size="'small'" :max="1000" />
			</p>
			...
			<p>
				...
				<NcProgressBar :value="document.completely_generated_prob" :size="'small'" :max="1000" />
			</p>
			<p style="font-size: 0.85em">
			...
			<p>
				...
				{{ overall_burstiness }}
				<NcProgressBar :value="document.overall_burstiness" :size="'small'" :max="1000" />
			</p>
			<p style="font-size: 0.85em">
