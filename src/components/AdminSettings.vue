<template>
	<div id="gptzero_prefs" class="section">
		...
		<div class="results-desc">
			<p>
				<b>completely_generated_prob</b> > {{ state.completely_generated_prob_max }} - {{ t('integration_gptzero', 'Most likely generated by an AI') }}
			</p>
			<p>
				{{ state.completely_generated_prob_min }} {{ '>=' }} <b>completely_generated_prob</b> {{ '<=' }} {{ state.completely_generated_prob_max }} - {{ t('integration_gptzero', 'Partially based on input or other sources. Unknown really') }}
			</p>
			<p>
				<b>completely_generated_prob</b> {{ '<' }} {{ state.completely_generated_prob_min }} - {{ t('integration_gptzero', 'Most likely written by a Human') }}
			</p>
		</div>
	</div>
</template>
